...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <p>Update workshop registration details</p>
        </div>
        
        <div class="form-container">
            <div class="info-box">
                <h4>Editing Registration #{{ $registration->id }}</h4>
                <p>Registered on: {{ $registration->registered_at->format('M j, Y g:i A') }}</p>
            </div>
            
            <form method="POST" action="{{ route('workshop.admin.update', $registration->id) }}">
                @csrf
                @method('PUT')
